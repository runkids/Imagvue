...
var define;
var t,e=require("babel-runtime/helpers/typeof"),r=a(e),n=require("babel-runtime/helpers/extends"),i=a(n);function a(t){return t&&t.__esModule?t:{default:t}}!function(){function e(t){return parseInt(t,10)}function n(t){var r=e(t);return r>=0&&r<=100}function a(){return{name:"imagvue",props:{value:{type:String,required:!0},onerror:{type:Function,default:function(){}},height:{type:[String,Number],default:"auto"},width:{type:[String,Number],default:"auto"},blur:{type:[String,Number],default:"0",validator:function(t){return e(t)>=0}},contrast:{type:[String,Number],default:"100",validator:function(t){return e(t)>=0}},brightness:{type:[String,Number],default:"100",validator:function(t){return e(t)>=0}},grayscale:{type:[String,Number],default:"0",validator:function(t){return n(t)}},hueRotate:{type:[String,Number],default:"0",validator:function(t){var r=e(t);return r>=0&&r<=360}},invert:{type:[String,Number],default:"0",validator:function(t){return n(t)}},opacity:{type:[String,Number],default:"100",validator:function(t){return n(t)}},saturate:{type:[String,Number],default:"100",validator:function(t){return e(t)>=0}},sepia:{type:[String,Number],default:"0",validator:function(t){return n(t)}},dropShadow:{type:Object,default:null},customData:{type:Object,default:null}},data:function(){return{lazyLoadMode:!1,lazyTime:500,lazyLoadImage:"",io:null}},render:function(t){var e=this.$slots.default;if(e&&1===e.length){var r=e[0];r.componentOptions&&"transition-group"===r.componentOptions.tag&&(this.lazyLoadMode=!0,this.lazyLoadImage=r.data.attrs.src,this.lazyTime=r.data.attrs.lazy||500)}var n=e,a=null,o=function(t,e){var r,n,i;r=a,n=t,a=null==(i=e)?r:((r=r||{})[n]=i,r)},u=(0,i.default)({},this.$attrs,{src:this.lazyLoadMode?this.lazyLoadImage:this.value,width:this.width,height:this.height},this.lazyLoadMode?{"data-src":this.value}:{}),s={filter:"\n            blur("+this.blur+"px) \n            contrast("+this.contrast+"%)\n            brightness("+this.brightness+"%)\n            grayscale("+this.grayscale+"%)\n            hue-rotate("+this.hueRotate+"deg)\n            opacity("+this.opacity+"%)\n            invert("+this.invert+"%)\n            saturate("+this.saturate+"%)\n            sepia("+this.sepia+"%)\n            "+function(t){if(null!==t){var e=t.offset,r=t.blurRadius,n=void 0===r?0:r,i=t.spreadRadius,a=void 0===i?0:i,o=t.color;return"drop-shadow("+e+"px "+n+"px "+a+"px "+(void 0===o?"black":o)+")"}return""}(this.dropShadow)+"\n          "},l={error:this.onerror};if(o("style",s),o("attrs",u),o("on",l),this.customData){var d=this.customData,f=d.on,h=d.props;o("on",(0,i.default)({},f,l)),o("props",h)}return t("img",a,n)},methods:{listenScrollEvent:function(t){var e=this;t[0].intersectionRatio&&setTimeout(function(){var r=t[0].target;r.src=r.getAttribute("data-src"),e.unObserve()},this.lazyTime)},unObserve:function(){this.io&&this.io.unobserve(this.$el)}},mounted:function(){this.lazyLoadMode&&"IntersectionObserver"in window&&(this.io=new IntersectionObserver(this.listenScrollEvent),this.io.observe(this.$el))},beforeDestroy:function(){this.unObserve()}}}if("object"===("undefined"==typeof exports?"undefined":(0,r.default)(exports)))module.exports=a();else if("function"==typeof t&&t.amd)t([],a());else if(window&&window.Vue){var o=a();Vue.component("imagvue",o)}}();
